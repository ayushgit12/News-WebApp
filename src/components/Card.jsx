...
function card(data) {
  ...
  return (
    <div className={`bg-cyan-200 w-96 justify-center shadow-md rounded-md shadow-cyan-500 ${a!=4?'hover:scale-105':''} transition-all cursor-pointer ${a===4?'scale-110 bottom-1/4 right-1/3 z-10 fixed':''}`} onClick={popup}>
